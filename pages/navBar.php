...
<nav class="navbar navbar-expand-lg bg-white py-1">
        <div class="container-fluid">
            <a class="navbar-brand" href="./index.php">
                <img src="../logo.jpg" alt="وظفني" height="100" >
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./faq.php">الأسئلة الشائعة</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="d-flex gap-2">
                    <a href="./userSignup.php" class="btn btn-custom-primary">سجل كفرد</a>
                    <a href="./companiesSignup.php" class="btn btn-custom-primary">سجل كمنشأة</a>
                </div>
            </div>
        </div>
    </nav>